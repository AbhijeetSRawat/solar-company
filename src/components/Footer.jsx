...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-yellow-900 via-orange-700 to-yellow-500 text-white py-10 ">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">

        {/* About Section */}
        <div>
          <h3 className="text-xl font-bold mb-4">SolarCo</h3>
          <p className="text-yellow-100">
            Bringing clean, affordable solar energy to your doorstep.  
            Save money and the planet with our trusted solar solutions.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex space-x-4">
            ...
            <a href="https://linkedin.com" className="hover:text-yellow-400" aria-label="LinkedIn">
      ...
      {/* Copyright */}
      <div className="mt-8 text-center text-yellow-200 text-sm">
